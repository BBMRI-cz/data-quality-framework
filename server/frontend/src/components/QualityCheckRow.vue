  ...
  <div class="check-row card border-0 shadow-sm mb-2" @click="handleCardClick">
    <div class="card-body">
      <div class="check-row-content">
        ...
        <!-- Status Badge -->
        <div class="check-status" v-if="checkStatus === CheckStatus.FAILED">
        ...
        <div class="site-results-container">
          ...
          <div class="site-list">
            ...
            >
              ...
              <span class="site-item-result">{{ siteResult.formattedCount }}/{{ siteResult.formattedPercentage }}</span>
            </div>
          </div>
        </div>
      </div>
...
const siteResults = computed(() => {
  ...
  reportsByAgent.forEach((report, agentId) => {
    ...
    const resultPercentage = checkResult.result <= 1 ? checkResult.result : checkResult.result / 100
