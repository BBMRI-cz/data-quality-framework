    ...
    <Transition name="backdrop" appear>
      ...
      >
        ...
        <Transition name="modal" appear @after-enter="onModalEntered">
          <div v-if="show" :class="modalDialogClasses" role="document">
...
<script setup>
  ...
  const emit = defineEmits(['close', 'save', 'backdrop-click', 'escape-key']);
  ...
  const footerClasses = computed(() => ['modal-footer', `modal-footer--${props.variant}`]);
