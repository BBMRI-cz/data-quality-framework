    ...
    <div v-if="showBanner" class="cookie-consent-banner">
      <div class="cookie-consent-content">
        <div class="cookie-consent-text">
          ...
          <p class="mb-0">
            This website uses essential browser storage (localStorage) to maintain your login
            session and improve your experience. We store your authentication token and user
            preferences locally. No tracking or analytics cookies are used.
          </p>
        </div>
        <div class="cookie-consent-actions">
          <button class="btn btn-primary btn-accept" @click="acceptCookies">
      ...
      <transition name="expand">
        <div v-if="showDetails" id="cookie-details-section" class="cookie-details">
