...
    day: 'numeric',
    year: 'numeric'
    // IMPLICATION: Since time is displayed separately, explicitly keeping the date part in UTC
    // prevents the date from shifting to the previous day if the local time is far behind UTC.
...
    hour: '2-digit',
    minute: '2-digit',
    hour12: false, // Ensure 24-hour format (e.g., 14:30)
    timeZoneName: 'short', // <-- FIX: Includes the timezone abbreviation (e.g., IST, GMT)
    second: '2-digit' // IMPROVEMENT: Added seconds for better audit logging
  })
}
