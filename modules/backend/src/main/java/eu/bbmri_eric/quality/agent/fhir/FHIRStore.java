...
/**
 * Represents an abstraction over a FHIR data store capable of creating, posting,
 * and evaluating FHIR resources such as Libraries and Measures.
 * It provides methods to interact with and query the FHIR backend.
 */
public interface FHIRStore {
   ...
   * @param elements     a list of element names to include in the response (can be empty for full resources)
