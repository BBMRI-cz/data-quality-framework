        ...
        <div class="user-dropdown">
          ...
          <div v-if="showDropdown" class="dropdown-menu-custom">
            <button class="dropdown-item-custom" @click="showChangePasswordModal">
              ...
              Change Password
              <span v-if="defaultPasswordFlag" class="badge bg-warning text-dark ms-2"
                >Required</span
              >
            </button>
...
<script setup>
  ...
  const { defaultPasswordFlag } = storeToRefs(userStore);
  const { initializeDefaultPasswordStatus } = userStore;
