  ...
  <div class="quality-check-page">
    ...
    <div class="page-content">
      <div class="form-container">
        <form @submit.prevent="onSave" class="quality-check-form">
          ...
          <QualityCheckThresholds
            v-model:warningThreshold="formData.warningThreshold"
            v-model:errorThreshold="formData.errorThreshold"
            v-model:epsilonBudget="formData.epsilonBudget"
          />
