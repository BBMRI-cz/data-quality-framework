...
const router = createRouter({
    ...
    routes: [
        ...
        { path: '/quality-checks/new', component: () => import('@/views/QualityCheckEditPage.vue'), meta: { requiresAuth: true } },
        { path: '/quality-checks/:id/edit', component: () => import('@/views/QualityCheckEditPage.vue'), meta: { requiresAuth: true } },
