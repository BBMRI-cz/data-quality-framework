...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: Impossible birth year (in the future or before 20th century)',
...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: Gender-Incompatible Diagnosis',
...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: Missing diagnosis or condition',
...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: No recent visit in the last year',
...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: Conditions without onset date',
...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: Persons without source identifier',
...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: Persons without birth year',
...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: Specimens without collection date',
...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: Specimens without specimen concept',
...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: Specimens without anatomic site concept',
...
INSERT INTO quality_check (name, description, query, check_type, warning_threshold, error_threshold)
VALUES (
    'OMOP: Specimens without specimen type concept',
